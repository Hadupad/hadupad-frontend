      ...
      <div className="min-h-screen bg-white">
        ...
        <main className="pt-[100px] px-4 sm:px-6 lg:px-8 pb-8 relative z-10">
          <div className="max-w-6xl mx-auto">
            ...
            {/* Skeleton for PropertyGallery */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
              <div className="h-[300px] bg-gray-200 rounded-lg animate-pulse"></div>
              <div className="grid grid-cols-2 gap-4">
                <div className="h-[140px] bg-gray-200 rounded-lg animate-pulse"></div>
                <div className="h-[140px] bg-gray-200 rounded-lg animate-pulse"></div>
                <div className="h-[140px] bg-gray-200 rounded-lg animate-pulse"></div>
                <div className="h-[140px] bg-gray-200 rounded-lg animate-pulse"></div>
              </div>
            </div>
            {/* Skeleton for Desktop Layout */}
            <div className="hidden lg:grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2 max-w-4xl">
                {/* Skeleton for PropertySectionNav */}
                <div className="flex space-x-4 border-b border-gray-200 pb-2 mb-6">
                  {Array(5).fill().map((_, index) => (
                    <div key={index} className="h-6 bg-gray-200 rounded w-20 animate-pulse"></div>
                  ))}
                </div>
            ...
            {/* Skeleton for Mobile Layout */}
            <div className="lg:hidden space-y-4 mt-6">
              {Array(5).fill().map((_, index) => (
                <div key={index} className="border border-gray-200 rounded-lg overflow-hidden">
                  <div className="w-full px-4 py-4 bg-white flex items-center justify-between">
