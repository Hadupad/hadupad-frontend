...
//   // Backend formula excludes serviceFee
//   const total = basePrice - calculatedDiscount + cleaningFee + cautionFee;
...
// export default function BookingCard({ property }) {
//   const [checkIn, setCheckIn] = useState(null); // Changed to null for DatePicker
//   const [checkOut, setCheckOut] = useState(null); // Changed to null for DatePicker
//   const [guests, setGuests] = useState(2);
//   const [nights, setNights] = useState(0);
//   const [specialRequests, setSpecialRequests] = useState('');
//   const [isModalOpen, setIsModalOpen] = useState(false);
...
//   const basePrice = property.price * nights;
//   const discountPercent = property.discountPercent || 0;
//   const calculatedDiscount = discountPercent; // Note: This seems incomplete in the original code
//   const cleaningFee = property.cleaningFee || 0;
//   const cautionFee = property.cautionFee || 0;
//   const serviceFee = property.serviceFee || 0;
...
//               minDate={checkIn ? new Date(checkIn.getTime() + 24 * 60 * 60 * 1000) : new Date()} // Ensure check-out is after check-in
//             />
//           </div>
//         </div>
