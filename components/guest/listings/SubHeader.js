  ...
  return (
    <div className="flex items-center justify-between py-4 ">
      ...
      <div className="flex items-center space-x-2">
        ...
        <div className="group relative flex items-center">
          <button onClick={onCreateClick} className="flex items-center h-9 rounded-full bg-white hover:bg-red-600 shadow border overflow-hidden transition-all duration-300 w-9 group-hover:w-32">
            <div className="w-9 h-9 flex items-center justify-center flex-shrink-0">
              <Plus className="w-4 h-4 text-gray-700 group-hover:text-white transition-colors duration-300" />
            </div>

            {/* Hidden text that appears on hover */}
            <span className="whitespace-nowrap pr-3 text-sm text-gray-700 group-hover:text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              CREATE
            </span>
          </button>
        </div>
