...
export default function LetsTalk() {
  return (
    <section className="px-4 py-16 max-w-7xl mx-auto grid md:grid-cols-3 gap-12 items-start">
      <div className="space-y-6 py-20 pt-20 md:col-span-1">
        <h2 className="text-2xl md:text-3xl font-bold">Let&apos;s Talk</h2>
        <p className="text-gray-700">
          Hadupad is here to help you; Our experts are available to answer any
        ...
        <div>
          ...
          <p className="text-gray-700">
            Office no. G-02 Building 1, Ground Floor. Abuja Media City – Lagos
          </p>
        </div>

        <div>
          <h4 className="font-semibold mb-1">Email Us</h4>
          <a href="mailto:hadupad@gmail.com" className="underline">
            hadupad@gmail.com
          </a>
        </div>
        <h4>OUR CHANELS</h4>
    ...
    priority // If these are above-the-fold images
  />
        </div>
        <div
          className="absolute top-50 left-2 overflow-hidden shadow-lg"
          style={{ zIndex: 10 }}
        >
          {/* <image
