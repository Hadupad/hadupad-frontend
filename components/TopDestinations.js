...
export default function FeaturedProperties() {
  ...
  return (
    <section className="px-4 py-50 md:px-12 py-10">
      {/* <div className="flex items-center justify-between mb-6">
        <h2 className="text-center text-2xl font-semibold text-black ">Top Destinations in Abuja</h2>
        <p className="text-gray-600 text-sm mt-3 text-center">Top feature attraction</p>
        <a className="text-sm font-medium text-black flex items-center gap-1 mt-5" href="#">
...
<div className="relative mb-6">
  ...
  <div className="text-center">
    <h2 className="text-2xl font-semibold text-black">Top Destinations in Abuja</h2>
    <p className="text-gray-600 text-sm mt-1">Top feature attraction</p>
  </div>
  
  {/* Right-aligned "Explore All" positioned below */}
