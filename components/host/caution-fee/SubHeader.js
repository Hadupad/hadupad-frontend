    ...
    <div className="flex items-center justify-between ">
      <div>
        ...
        <p className="text-gray-400">
          Refundssss are reviewed automatically upon clearance of guests
        </p>
      </div>
      <div className="flex items-center space-x-2">
        ...
        <div className="flex items-center space-x-2">
          ...
          <div className="group relative flex items-center">
          <button className="flex items-center justify-center gap-1.5 bg-[#DC4731] hover:bg-[#c03e2b] text-white py-1.5 px-4 rounded-full text-sm transition-colors duration-200">
